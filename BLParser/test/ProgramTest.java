...
public abstract class ProgramTest {
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseDuplicateError() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParsePrimitiveError() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorNoBegin() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorNoIS() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
